            ...
            child: gymsAsync.when(
              ...
              data: (gyms) {
                final filtered = _query.isEmpty
                    ? gyms
                    : gyms.where((g) =>
                        g.gtNameTitle.toLowerCase().contains(_query) ||
                        g.gtCityName.toLowerCase().contains(_query)).toList();
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            _query.isEmpty
                                ? 'Kembali lagi nanti saat ada gym baru.'
                                : 'Coba nama atau kota lain.',
                            style: theme.textTheme.bodyMedium?.copyWith(
                                color: AppColors.lightSecondaryText),
                            textAlign: TextAlign.center,
                          ),
...
class _GymCard extends StatelessWidget {
        ...
        children: [
          Container(
            ...
            child: gym.gtImage.isNotEmpty
                ? Image.network(gym.gtImage, width: double.infinity, height: 130,
                    fit: BoxFit.cover, errorBuilder: (context, error, stackTrace) => _placeholder())
                : _placeholder(),
          ),
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    Icon(Icons.location_on_outlined, size: 13, color: AppColors.lightSecondaryText),
                    const SizedBox(width: 4),
                    Expanded(
                      child: Text('${gym.gtCityName} · ${gym.gtLocation}',
                ...
                if (gym.gtAvailableFacilities.isNotEmpty) ...[
                  ...
                  Wrap(
                    ...
                    children: gym.gtAvailableFacilities.take(4).map((f) => Container(
                      padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 3),
                      decoration: BoxDecoration(
                        color: theme.colorScheme.onSurface.withValues(alpha: 0.05),
                        borderRadius: BorderRadius.circular(4),
                      ),
                      child: Text(f, style: theme.textTheme.labelSmall?.copyWith(
                          color: AppColors.lightSecondaryText)),
                    )).toList(),
                  ),
                ],
  ...
  Widget _placeholder() => Center(
    child: Icon(Icons.fitness_center_outlined, size: 40,
      ...
      child: Column(
        ...
        children: [
          Text(label, style: Theme.of(context).textTheme.labelSmall?.copyWith(
              color: AppColors.lightSecondaryText, fontSize: 10)),
