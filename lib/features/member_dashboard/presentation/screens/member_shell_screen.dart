        ...
        child: Column(
          ...
          children: [
            ...
            _action(
              ...
              sub: 'Scan QR dari owner untuk bergabung',
              onTap: () {
                Navigator.pop(ctx);
                Navigator.of(context).push(
                  MaterialPageRoute(
                    builder: (_) => const MemberScanMembershipScreen(),
                  ),
                );
              },
            ),
            ...
            _action(
              ...
              sub: 'Tunjukkan QR ini ke owner untuk check-in',
              onTap: () {
                Navigator.pop(ctx);
                ...
                if (membership != null && membership.isActive) {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(
                      content: Text(
                        'Anda belum memiliki membership aktif. Cari gym terlebih dahulu.',
                      ),
                    ),
                  );
                }
            ...
            _action(
              ...
              sub: 'Tunjukkan QR ini untuk absensi kelas',
              onTap: () {
                Navigator.pop(ctx);
                ScaffoldMessenger.of(context).showSnackBar(
                  const SnackBar(
                    content: Text(
                      'Aktifkan langganan kelas terlebih dahulu untuk mendapatkan QR kelas.',
                    ),
