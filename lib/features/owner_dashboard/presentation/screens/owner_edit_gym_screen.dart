...
class _State extends ConsumerState<OwnerEditGymScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: OwnerTopBar(ownerName: ownerName, onAvatarTap: () {}),
      body: gymAsync.when(
        ...
        data: (gym) {
          ...
          if (!_initialized) {
            ...
            _memberPriceCtrl.text = gym.gtMembershipPriceAmount
                .toInt()
                .toString();
            _facilities.clear();
              ...
              child: Column(
                ...
                children: [
                  ...
                  SwitchListTile(
                    ...
                    subtitle: const Text(
                      'Gym akan muncul di pencarian member jika aktif',
                    ),
                    value: _isActive,
  ...
  Future<void> _save(String gymId) async {
    ...
    try {
      ...
      if (memberPrice != null) {
        updateData['gt_membership_price_amount'] = memberPrice;
      }
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Profil gym berhasil diperbarui')),
        );
      }
    } catch (e) {
      if (mounted) {
