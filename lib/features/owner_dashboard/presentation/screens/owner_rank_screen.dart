...
class OwnerRankScreen extends ConsumerWidget {
            ...
            builder: (context, snapshot) {
              ...
              final docs = [...(snapshot.data?.docs ?? [])]
                ..sort((a, b) {
                  ...
                  final aPoints =
                      (aData['rank_min_points_threshold'] as num?)?.toInt() ??
                      0;
                  final bPoints =
                      (bData['rank_min_points_threshold'] as num?)?.toInt() ??
                      0;
                ...
                return Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'Tambahkan benefit rank untuk member',
              ...
              return ListView.separated(
                ...
                itemBuilder: (context, i) {
                  ...
                  return InkWell(
                    onTap: () =>
                        _showForm(context, ref, existing: d, docId: docs[i].id),
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  'Minimal ${d['rank_min_points_threshold'] ?? 0} poin',
  ...
  void _showForm(
    ...
    final titleCtrl = TextEditingController(
      text: existing?['rank_title_name'] ?? '',
    );
    final pointsCtrl = TextEditingController(
      text: ((existing?['rank_min_points_threshold'] as num?)?.toInt() ?? '')
          .toString(),
    );
    final benefitCtrl = TextEditingController(
      text:
          (existing?['rank_benefit_description_list'] as List?)?.join(', ') ??
          '',
    );
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _inp(
                    ...
                    validator: (v) {
                      if (v == null || v.trim().isEmpty) {
                        return 'Minimum poin wajib diisi';
                      }
                  ...
                  Text(
                    'Urutan rank otomatis mengikuti minimum poin. Rank dengan poin paling kecil muncul lebih dulu.',
                  ...
                  _inp(
                    ...
                    validator: (v) {
                      if (v == null || v.trim().isEmpty) {
                        return 'Daftar benefit wajib diisi';
                      }
                      final list = v
                          .split(',')
                          .map((s) => s.trim())
                                  ...
                                  try {
                                    ...
                                    if (isEdit) {
                                      await FirebaseFirestore.instance
                                          ...
                                          .doc(docId)
                                          .update({
                                            'rank_title_name': titleCtrl.text
                                                .trim(),
                                            'rank_min_points_threshold':
                                                minPoints,
                                            'rank_benefit_description_list':
                                                benefits,
                                            'rank_priority_order': minPoints,
                                          });
                                    } else {
